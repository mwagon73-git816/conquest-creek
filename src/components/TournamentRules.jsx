      ...
      <div className="text-sm text-blue-800 space-y-3">
        ...
        <div>
          ...
          <ul className="space-y-1">
            <li>• Team Roster: Maximum 14 players per team (any gender distribution allowed)</li>
        ...
        <div>
          ...
          <ul className="space-y-1">
            ...
            <li>• Full Roster Participation: +1 per month if all team members play (up to 14)</li>
