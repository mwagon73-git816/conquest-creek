...
import { Trophy, Users, Calendar, TrendingUp, UserPlus, Shield, Activity, Image, Swords, ClipboardCheck, Calculator } from 'lucide-react';
...
const TabNavigation = ({ activeTab, setActiveTab, userRole, isAuthenticated }) => {
  const allTabs = [
    ...
    { id: 'bonus-audit', icon: ClipboardCheck, label: 'Bonus Audit', roles: ['director'] },
    { id: 'points-audit', icon: Calculator, label: 'Points Audit', roles: ['director'] }
  ];
